...
export default function StoreButtons({ className = "" }: StoreButtonsProps) {
  return (
    <div className={`flex flex-col sm:flex-row items-center justify-center gap-3 ${className}`}>
      ...
      <a
        href="#"
        className="group flex items-center gap-3 px-6 py-3 rounded-xl bg-foreground text-background hover:bg-foreground/90 transition-colors w-full sm:w-auto justify-center"
      >
