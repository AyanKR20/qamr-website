...
export const IOS_URL = "https://apps.apple.com/app/qamr/id6764144560";
...
export default function StoreView() {
  return (
    <>
      <StoreRedirect iosUrl={IOS_URL} androidUrl={ANDROID_URL} />
      <div className="qamr-store">
        <div className="bg-orb" aria-hidden />
        <div className="bg-warm" aria-hidden />

        <main className="store-inner">
          {/* Fixed-size local asset; avoiding next/image keeps the redirect page's JS smaller. */}
          ...
          <p className="store-fallback">
            Opening the right store. If nothing happens, choose below.
          </p>

          <div className="store-buttons">
            <StoreButton kind="ios" href={IOS_URL} />
            <StoreButton kind="android" href={ANDROID_URL} />
          </div>
        </main>
      </div>
    </>
...
function StoreButton({
  ...
  return (
    <a
      href={href}
      className="sb sb-android"
      aria-label="Get it on Google Play"
      data-store-target="android"
    >
      <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden>
